    ...
    <aside className="w-full lg:w-80 shrink-0 select-none">
      <div className="bg-[#121212] border border-[#E0D8D0]/10 rounded-2xl p-6 shadow-sm sticky top-6 hover:shadow-md transition-shadow duration-300 flex flex-col gap-6">
        ...
        <div className="relative group flex flex-col items-center">
          <div className="w-48 h-64 md:w-64 md:h-80 rounded-2xl bg-gradient-to-tr from-[#E0D8D0]/50 via-[#E0D8D0]/10 to-[#E0D8D0]/45 p-[2px] shadow-lg transition-transform duration-500 group-hover:scale-105 overflow-hidden">
            <div className="w-full h-full bg-[#121212] rounded-[13px] flex items-center justify-center overflow-hidden">
              <img 
                src="/img/miaimmagine.png" 
